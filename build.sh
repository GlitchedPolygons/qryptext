...
cmake -DBUILD_SHARED_LIBS=Off -DUSE_SHARED_MBEDTLS_LIBRARY=Off -DQRYPTEXT_ENABLE_PROGRAMS=On -DCMAKE_BUILD_TYPE=Release ..
make
cp -r ../include .
tar -czvf qryptext.tar.gz programs/qryptext_* *.a include/*
cd "$REPO" || exit
