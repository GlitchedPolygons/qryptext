...
#define QRYPTEXT_DECRYPTION_ERROR_INSUFFICIENT_OUTPUT_BUFFER_SIZE 2001
#define QRYPTEXT_DECRYPTION_ERROR_INVALID_KYBER_KEY_FORMAT 2002
#define QRYPTEXT_DECRYPTION_ERROR_INVALID_RSA_KEY_FORMAT 2003
#define QRYPTEXT_DECRYPTION_ERROR_OUT_OF_MEMORY 2004
